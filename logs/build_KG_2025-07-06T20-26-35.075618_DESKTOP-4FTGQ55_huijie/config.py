...
if task == 'gen_plan':
    ...
    if design_name == 'apb':
    ...
    elif design_name == 'ecg':
        input_file_path = (         'C:\\Users\\huijie\\Desktop\\AssertionForge\\design\\ecg\\spec\\ecg.pdf'
        )
    elif design_name == 'ethernet':
        input_file_path = (         'C:\\Users\\huijie\\Desktop\\AssertionForge\\design\\ethernet\\spec\\ethernet.pdf'
        )
    elif design_name=='i2c':
        input_file_path=(
            'C:\\Users\\huijie\\Desktop\\AssertionForge\\design\\i2c\\spec\\i2c.pdf'
        )
    elif design_name=='pairing':
        input_file_path=(
            'C:\\Users\\huijie\\Desktop\\AssertionForge\\design\\pairing\\spec\\pairing.pdf'
        )
        ...
        assert False
#Measure-Command {graphrag index --root C:\Users\huijie\Desktop\AssertionForge\design\i2c\spec\graph_rag_i2c}
    ...
    entity_extraction_prompt_source_path = f'C:\\Users\\huijie\\Desktop\\AssertionForge/rag_apb/extract_graph.txt'  # better- customized for HW
